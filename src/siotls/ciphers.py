...
class _TLSSecrets:
    def __init__(self, digestmod, hashempty, hashzeros):
        ...
        self.hashempty = hashempty
        self.hashzeros = hashzeros
        self._salt = self.hashzeros
    ...
    def _make_deriver(self, ikm, transcript_hash, *, update_salt):
        ...
        if update_salt:
            self._salt = derive_secret(
                self._digestmod, secret, b'derived', self.hashempty)
    ...
    def derive_early_secrets(self, psk, psk_mode, client_hello_transcript_hash):
        ...
        binder_key = derive_early_secret(psk_label, transcript_hash=self.hashempty)
    ...
    def derive_master_secrets(
        ...
        derive_master_secret = self._make_deriver(
            self.hashzeros, server_finished_transcript_hash, update_salt=False)
