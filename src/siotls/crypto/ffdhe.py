...
ffdhe6144 = DHNumbers(f(ffdhe6144_p), 2, f(ffdhe6144_q), len(ffdhe6144_p), 375)
ffdhe8192 = DHNumbers(f(ffdhe8192_p), 2, f(ffdhe8192_q), len(ffdhe8192_p), 400)
groups = {
...
if __name__ == '__main__':
    ...
    print("validating 2048... ", end="", flush=True)
    assert ffdhe2048.q == ffdhe2048.p // 2
    assert isprime(ffdhe2048.p)
    assert isprime(ffdhe2048.q)
    print("ok")

    print("validating 3072... ", end="", flush=True)
    assert ffdhe3072.q == ffdhe3072.p // 2
    assert isprime(ffdhe3072.p)
    assert isprime(ffdhe3072.q)
    print("ok")

    print("validating 4096... ", end="", flush=True)
    assert ffdhe4096.q == ffdhe4096.p // 2
    assert isprime(ffdhe4096.p)
    assert isprime(ffdhe4096.q)
    print("ok")

    print("validating 6144... ", end="", flush=True)
    assert ffdhe6144.q == ffdhe6144.p // 2
    assert isprime(ffdhe6144.p)
    assert isprime(ffdhe6144.q)
    print("ok")

    print("validating 8192... ", end="", flush=True)
    assert ffdhe8192.q == ffdhe8192.p // 2
    assert isprime(ffdhe8192.p)
    assert isprime(ffdhe8192.q)
    print("ok")
