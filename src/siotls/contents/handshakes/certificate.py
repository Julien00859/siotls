...
class CertificateEntry(Serializable):
    ...
    @classmethod
    def parse(cls, stream, certificate_type: CertificateType):
        ...
        return cls(certificate_type, certificate, extensions)
...
class Certificate(Handshake, SerializableBody):
    ...
    def parse_body(cls, stream, *, certificate_type):
        try:
            ...
            raise alerts.CertificateUnknown from e
        ...
        try:
            ...
            raise alerts.IllegalParameter from e
